...
Currently, I'm not allowed to share the raw data, which is why they're not on the Github repo yet.
...
working_file <-
  ...
  mutate(
    across(
      c(
        covid_work_home_often:covid_none,
...
# save working file
saveRDS(working_file, here("data", "processed_data.rds"))
