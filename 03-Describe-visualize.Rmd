...
```{r correlation-matrix-use-well-being, echo=FALSE, message=F, warning=F, fig.cap="Correlation matrix of hours spent with a medium and well-being",fig.dim=c(14,14)}
ggpairs(
  data = working_file %>%
    select(
      contains("time"),
